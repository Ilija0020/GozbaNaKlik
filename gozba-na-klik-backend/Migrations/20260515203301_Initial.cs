        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeOfAddon = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MealAllergens", x => new { x.AlergenId, x.MealId });
                    table.ForeignKey(
                        name: "FK_MealAllergens_Allergens_AlergenId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkplaceRestaurantId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Users", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Users_Restaurants_WorkplaceRestaurantId",
                        column: x => x.WorkplaceRestaurantId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAllergens", x => new { x.AlergenId, x.UserId });
                    table.ForeignKey(
                        name: "FK_UserAllergens_Allergens_AlergenId",
                        column: x => x.AlergenId,
                        principalTable: "Allergens",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "admin1@gozba_na_klik.com", false, false, "Admin1", "admin1", null, "Admin", "Admin1", "admin1", null },
                    { 2, "admin2@gozba_na_klik.com", false, false, "Admin2", "admin2", null, "Admin", "Admin2", "admin2", null },
                    { 3, "admin3@gozba_na_klik.com", false, false, "Admin3", "admin3", null, "Admin", "Admin3", "admin3", null }
                });

            migrationBuilder.CreateIndex(
                name: "IX_Addons_MealId",
                table: "Addons",
                column: "MealId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourierWorkingHours_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NonWorkingDays_RestaurantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_WorkplaceRestaurantId",
                table: "Users",
                column: "WorkplaceRestaurantId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_CourierWorkingHours_Users_UserId",
                table: "CourierWorkingHours",
                column: "UserId",
                principalTable: "Users",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_NonWorkingDays_Restaurants_RestaurantId",
                table: "NonWorkingDays",
                column: "RestaurantId",
                principalTable: "Restaurants",
                principalColumn: "Id",
